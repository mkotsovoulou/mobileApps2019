...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colors.add(new Word("green", "prasino", R.drawable.color_green, R.raw.prasino));
        colors.add(new Word("red", "kokkino", R.drawable.color_red, R.raw.kokkino));
        colors.add(new Word("brown", "cafe", R.drawable.color_brown, R.raw.kafe));
        colors.add(new Word("grey", "gkri", R.drawable.color_gray, R.raw.gkri));
